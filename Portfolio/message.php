...
if(!empty($_POST["send"])) {
	...
	$connexion = mysqli_connect("localhost", "root", "", "portfolio") or die("Erreur de connexion: " . mysqli_error($connexion));
	$result = mysqli_query($connexion, "INSERT INTO message (nom, mail, objet, message) VALUES ('" . $name. "', '" . $email. "','" . $subject. "','" . $message. "')");
	if($result){
...
if(!empty($_POST["send"])) {
	...
	$toEmail = "anais.riollaci91@gmail.com";
